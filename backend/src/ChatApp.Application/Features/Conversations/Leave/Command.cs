...
/// <summary>Removes the caller from a conversation's membership. When the caller is the owner, <paramref name="Mode"/> is required and chooses delete vs. freeze (<c>OwnerId = null</c>); otherwise it's ignored.</summary>
